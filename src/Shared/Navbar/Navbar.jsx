        ...
        <nav className='flex items-center py-3'>
           <div className='flex gap-4 items-center md:w-3/12'>
            <img className='w-13 h-13' src={logo} alt="" />
             <h1 className='text-2xl font-bold'>BazaarTracker <span className='text-green-500'>BD</span></h1>
           </div>
           ...
           <div className='mx-4'>
            ...
            <div>
                 <Link className="text-[20px] font-semibold text-[#00B795] flex items-center gap-2">
